...
lambda_functions = {
    config.env.func_fullname_start_hil: {
        "lambda_memory_size": 128,
        "lambda_timeout": 3,
    },
    config.env.func_fullname_post_process: {
        "lambda_memory_size": 128,
        "lambda_timeout": 3,
    },
}
...
try:
    ...
    stages[EnvEnum.dev] = {
        ...
        "layers": [
            "arn:aws:lambda:{{ cookiecutter.aws_region }}:{{ cookiecutter.aws_account_id }}:layer:{{ cookiecutter.package_name }}:2",
        ],
