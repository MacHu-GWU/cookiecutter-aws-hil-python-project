...
class Output:
    ...
    iam_role_human_review_workflow_arn: str = attr.ib()
    ...
    def _get_from_stack(cls, env_name: str) -> "Output":
        ...
        try:
            return cls(
                ...
                iam_role_human_review_workflow_arn=stack.get_output_value(
                    bsm, stack.output_iam_role_for_human_review_workflow_arn.id
                ),
            )
    ...
    def _get_from_env_var(cls) -> "Output":
        ...
        return cls(
            iam_role_lambda_arn="",
            iam_role_human_review_workflow_arn="",
        )
